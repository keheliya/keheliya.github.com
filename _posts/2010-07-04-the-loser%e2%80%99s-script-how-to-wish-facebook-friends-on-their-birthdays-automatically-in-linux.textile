...
[sourcecode language="text" light="true"]sudo apt-get install curl gnome-schedule[/sourcecode]
...
[sourcecode language="text" light="true"]https://graph.facebook.com/oauth/authorize?client_id=YOUR_APLICATION_ID&amp;redirect_uri=http://www.facebook.com/connect/login_success.html&amp;type=user_agent&amp;display=popup&amp;scope=offline_access,publish_stream,friends_birthday[/sourcecode]
...
[sourcecode language="text" light="true"]https://graph.facebook.com/oauth/access_token?client_id=YOUR_APLICATION_ID&amp;redirect_uri=http://www.facebook.com/connect/login_success.html&amp;client_secret=YOUR_API_SECRET&amp;code=VERIFICATION_CODE[/sourcecode]</li>
...
[sourcecode language="text" light="true"]./birthdayscript.sh[/sourcecode]
...
[sourcecode language="text" light="true"]gnome-schedule[/sourcecode]
